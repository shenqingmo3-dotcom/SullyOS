    ...
    return (
        <>
            <style>{`
                ...
                :where(.sully-schedule-change-before) { color:#94a3b8; text-decoration:line-through; }
            ...
            <div className="sully-schedule-change" role="status" aria-live="polite" aria-label="未来日程已调整">
                ...
                <div className="sully-schedule-change-head">
                    ...
                    {detail.changes.length > 1 && <span className="sully-schedule-change-count">{detail.changes.length} 项</span>}
                </div>
